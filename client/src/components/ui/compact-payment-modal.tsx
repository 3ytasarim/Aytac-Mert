          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              ...
              >
                ...
                {/* Adres Bilgisi Uyarısı */}
                <div className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-400 rounded-lg p-4 mb-4 address-warning-banner">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <div className="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center warning-icon">
                    ...
                    <div className="ml-3">
                      <h4 className="text-sm font-bold text-red-800 mb-1 warning-title">⚠️ Önemli: Adres Bilgisi Gerekli</h4>
                      <p className="text-sm text-red-700 leading-relaxed">
                        WhatsApp ile dekont gönderirken <strong>fatura için adres bilgilerinizi de yazmanız gerekmektedir</strong>. 
                        Tam adresinizi dekont ile birlikte göndermeyi unutmayın.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 text-center mb-4">
                  ...
                  <p className="text-sm text-gray-700 mb-3">
                    Ödeme dekontunuzu ve <strong>adres bilgilerinizi</strong> WhatsApp üzerinden gönderin
                  </p>
