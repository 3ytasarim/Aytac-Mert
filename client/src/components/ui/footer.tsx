          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 group">
              ...
              <div className="relative">
                ...
                <span className="ml-2 text-base font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-clip-text text-transparent animate-gradient-x group-hover:scale-105 transition-transform duration-300 inline-block">
